...
<div class="sidenav">
      ...
      <div class="main">
         <div class="col-md-6 col-sm-12">
            ...
            <form class="col-12" name="formulario" id="formulario"  method="post" action="user.php" 
...
<?php } ?>
       ...
       <i class='bx bxs-key bx-sm bx-tada'></i>         
        ...
        placeholder="Ingrese su contrase&ntilde;a">
         ...
         <button type="submit" onclick="validaciones()" class="btn btn-dark" name="userp" id="userp">
          Registrarse</button>
          <a type="submit" href="index.php" class="btn btn-success">
                Iniciar sesion
        </a>
        </form>
